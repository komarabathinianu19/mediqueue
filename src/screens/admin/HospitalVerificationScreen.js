...
//       Alert.alert("Approved ✓", `${hospital.name} is now approved and can login.`, [
//         { text: "OK", onPress: () => navigation.goBack() },
//       ]);
//     } catch (err) {
...
//       // Popup after rejection
//       Alert.alert("Rejected", `${hospital.name} has been rejected and removed.`, [
//         { text: "OK", onPress: () => navigation.goBack() },
//       ]);
//     } catch (err) {
...
//         {/* Updated fields to match Java Entity keys */}
//         <Info label="Owner Name" value={hospital.ownerName} />
//         <Info label="Mobile Number" value={hospital.phoneNumber} />
//         <Info label="Email" value={hospital.email} />
//         <Info label="Address" value={hospital.address} />
//         <Info label="Registration No" value={hospital.registrationNumber} />
//         <Info label="License No" value={hospital.licenseNumber} />
//         <Info label="Status" value={hospital.status} />
//       </View>

//       {/* Action buttons appear only for PENDING status */}
//       {hospital.status === "PENDING" && (
//         <View style={styles.row}>
//           <TouchableOpacity style={styles.approve} onPress={handleApprove}>
//             <Text style={styles.approveText}>Approve</Text>
...
//   backBtn: { marginTop: 52, width: 44, height: 44, borderRadius: 16, backgroundColor: COLORS.card, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: COLORS.border },
//   title: { marginTop: 16, fontSize: 24, fontWeight: "900", color: COLORS.text },
//   heroImage: { width: "100%", height: 180, borderRadius: 24, marginTop: 18, backgroundColor: COLORS.card },
//   card: { backgroundColor: COLORS.card, borderRadius: 22, padding: 18, marginTop: 18, borderWidth: 1, borderColor: COLORS.border, elevation: 2 },
//   name: { fontSize: 20, fontWeight: "900", color: COLORS.text },
//   city: { color: COLORS.muted, marginTop: 4, marginBottom: 14 },
//   infoRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 11, borderBottomWidth: 1, borderBottomColor: COLORS.border, gap: 12 },
//   label: { color: COLORS.muted, fontWeight: "700", flex: 1 },
//   value: { color: COLORS.text, fontWeight: "800", flex: 1, textAlign: "right" },
//   row: { flexDirection: "row", gap: 12, marginTop: 20, marginBottom: 34 },
//   approve: { flex: 1, height: 54, borderRadius: 16, backgroundColor: COLORS.staff, alignItems: "center", justifyContent: "center" },
//   reject: { flex: 1, height: 54, borderRadius: 16, backgroundColor: "#FEF2F2", alignItems: "center", justifyContent: "center" },
//   approveText: { color: "#fff", fontWeight: "900" },
