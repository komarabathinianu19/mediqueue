...
// export const BASE_URL = "http://10.81.209.249:8080/api"; // ← Your backend IP
...
// export const checkPhoneRegistered = async (phone) => {
//   const res = await fetch(
//     `${BASE_URL}/auth/check-phone?phone=${encodeURIComponent(phone)}`,
//     { headers: getPublicHeaders() }
//   );
//   const data = await res.json();
//   return data; // { registered: true/false }
...
// export const fetchReportById = async (reportId) => {
//   const headers = await authHeaders();
//   const res = await fetch(`${BASE_URL}/patient/reports/${reportId}`, { headers });
//   return handleRes(res);
// };  
...
// /**
//  * Clears patient session from AsyncStorage.
//  * Call this from patient profile/logout button.
//  */
...
// /**
//  * Clears staff (hospital) session from AsyncStorage.
//  * Call this from staff profile/logout button.
//  */
...
// /**
//  * Clears admin session from AsyncStorage.
//  * Call this from admin dashboard/logout button.
//  */
