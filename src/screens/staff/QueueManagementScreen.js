...
//     // Navigate to the FeedbackForm screen and pass relevant data (patient details, etc.)
...
//             style={styles.queueCard}
//             activeOpacity={0.86}
//             onPress={() => handleCompletedPress(item)} // On completed, trigger the feedback screen
//           >
//             <View style={styles.iconBox}>
//               <Ionicons
//                 name={
...
//     justifyContent: "center",
//   },
//   department: { color: COLORS.staff, fontSize: 17, fontWeight: "900" },
//   doctor: { color: COLORS.text, marginTop: 4, fontWeight: "900" },
//   slotText: { color: COLORS.staff, marginTop: 5, fontWeight: "900", fontSize: 12 },
//   statsLine: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 8, flexWrap: "wrap" },
//   statText: { color: COLORS.muted, fontWeight: "800", fontSize: 12 },
//   dot: { color: COLORS.muted, fontWeight: "900" },
//   emptyCard: {
//     backgroundColor: COLORS.card,
//     borderRadius: 24,
